package com.akbank.spring_app.presentation_api.controller;

import com.akbank.spring_app.domain.entity.Product;
import com.akbank.spring_app.application.handler.product.CreateProductRequestHandler;
...
import com.akbank.spring_app.application.request.product.ProductDeleteByNameRequest;
import com.akbank.spring_app.application.request.product.ProductStockInRequest;
import com.akbank.spring_app.application.request.product.ProductUpdateRequest;
...
public class ProductsController {
   ...
   //  private IProductRepository productRepository;
    ...
    private final CreateProductRequestHandler createProductRequestHandler;




//    // Dependency Injection (DI) -> Inversion of Control (IoC)
    public ProductsController(IProductRepository productRepository, IProductService productService, CreateProductRequestHandler createProductRequestHandler) {
        this.productRepository = productRepository;
        this.productService = productService;
        this.createProductRequestHandler = createProductRequestHandler;
    }
...
//        );
    ...
    public ResponseEntity<ProductDetailResponse> createProduct(@Valid @RequestBody ProductCreateRequest request) throws   Exception {
        ...
        var response = createProductRequestHandler.handle(request);
